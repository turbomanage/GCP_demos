...
project = 'cpb100-151023' # Replace [GCLOUD_PROJECT] with project
kind = 'President'

options = PipelineOptions(project=project)
p = beam.Pipeline(options=options)
lines = p | 'Read from Cloud Storage' >> beam.io.ReadFromText('gs://drfib/usa_presidents.csv') # Replace [GCLOUD_BUCKET] with Cloud Storage bucket
